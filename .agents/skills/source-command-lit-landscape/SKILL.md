---
name: "source-command-lit-landscape"
description: "Generate figures visualizing literature trends, citation patterns, and research gaps"
---

# source-command-lit-landscape

Use this compatibility skill when the user asks for `/lit-landscape`,
`lit-landscape`, or figures that visualize a literature.

## Command Template

Run the `literature-landscape` skill for the topic, paper set, JSON file, or
reading list identified in the user's prompt.
