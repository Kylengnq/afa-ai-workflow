...
Use this compatibility skill when the user asks for `/idea`, `idea`, or an
end-to-end screening of a specific finance or real estate research idea.

## Command Template

Run the `finance-idea-screening` skill on the idea from the user's prompt. If
the idea is missing, ask for it before searching.
